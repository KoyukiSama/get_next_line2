...
int main(void)
{
	...
	// int fd4 = open("test/test4.txt", O_RDONLY);
	// int fd5 = open("test/test5.txt", O_RDONLY);
	// int fd6 = open("test/test6.txt", O_RDONLY);
	// int fd7f0 = open("test/test7-0.txt", O_RDONLY);
	// int fd7f1 = open("test/test7-1.txt", O_RDONLY);
	// int fd7f2 = open("test/test7-2.txt", O_RDONLY);
	// int fd7f3 = open("test/test7-3.txt", O_RDONLY);
	// int fd8 = open("test/test8.txt", O_RDONLY);
	char *line;
	...
	int fdLOBSTER = open("test/testLOBSTER.txt", O_RDONLY);
